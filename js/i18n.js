...
const STRINGS = {
  fr: {
    ...
    ebirdPage: 'Voir sur eBird', viewFull: 'Voir en grand',
    ...
    reimport: 'Réimporter',
    newLifer: 'NOUVEAU',
    biggestDay: 'Plus d’espèces différentes en une journée', biggestLiferDay: 'Plus de nouvelles espèces en une journée', shiny: 'Chromatique',
  ...
  en: {
    ...
    ebirdPage: 'View on eBird', viewFull: 'View full size',
    ...
    reimport: 'Re-import',
    newLifer: 'NEW',
    biggestDay: 'Most different species in a day', biggestLiferDay: 'Most new species in a day', shiny: 'Shiny',
