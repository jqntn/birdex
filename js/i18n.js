...
const STRINGS = {
  fr: {
    ...
    firstSeen: 'Première observation', lastSeen: 'Dernière observation', location: 'Lieu', count: 'Total d\'individus',
    ebirdPage: 'Voir sur eBird',
    welcomeTitle: 'Bienvenue dans le Birdex',
    welcomeSub: 'Un Pokédex des oiseaux du monde réel, à partir de vos données eBird.',
  ...
  en: {
    ...
    firstSeen: 'First seen', lastSeen: 'Last seen', location: 'Location', count: 'Total individuals',
