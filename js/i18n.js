...
const STRINGS = {
  fr: {
    ...
    firstSeen: 'Première observation', lastSeen: 'Dernière observation', location: 'Lieu', count: 'Nombre',
  ...
  en: {
    ...
    firstSeen: 'First seen', lastSeen: 'Last seen', location: 'Location', count: 'Count',
