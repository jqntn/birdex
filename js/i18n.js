...
const STRINGS = {
  fr: {
    ...
    reimport: 'Réimporter',
    newLifer: 'NOUVEAU',
    biggestDay: 'Plus d’espèces en une journée', biggestLiferDay: 'Plus de nouvelles espèces en une journée', shiny: 'Chromatique',
  ...
  en: {
    ...
    reimport: 'Re-import',
    newLifer: 'NEW',
    biggestDay: 'Most species in a day', biggestLiferDay: 'Most new species in a day', shiny: 'Shiny',
